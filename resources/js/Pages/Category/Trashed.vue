                                        ...
                                        <tr v-for="(item, index) in plant.data" :key="index" class="hover:bg-green-300 border-b border-gray-200 bg-white">
                                            ...
                                            <td class="px-5 py-5 text-sm">
                                                <span class="relative inline-flex px-3 py-1 my-1 font-semibold text-purple-900 leading-tight">
                                                    ...
                                                    <inertia-link class="relative" :href='`/restore/plant/${item.id}`'>Restore</inertia-link>
                                                </span>
                                                <span class="relative inline-flex px-3 py-1 my-1 font-semibold text-red-900 leading-tight">
                                                    ...
                                                    <inertia-link method="Delete" preserve-scroll class="relative" as="button" :href='`/permanent-delete/plant/${item.id}`'>Delete</inertia-link>
                                                </span>
                                            </td>
                                        </tr>
                                    </tbody>

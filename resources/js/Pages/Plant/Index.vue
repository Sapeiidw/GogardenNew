...
<app-layout>
    <template #header>
        <div class="text-lg">Plant</div>
    </template>

    <div class="bg-purple-50">
        <div class="container px-4 mx-auto my-10">
            <!-- component -->
            <div class="antialiased font-sans bg-white rounded-xl shadow-md">
                <div class="container mx-auto px-4 sm:px-8">
                    <div class="py-8">
                        ...
                        <div class="my-2 flex sm:flex-row flex-col">
                            ...
                            <div>
                                <inertia-link href="/trashed/plant">Trashed</inertia-link>
                            </div>
                        </div>
                                        ...
                                        <tr v-for="(item, index) in plant" :key="index" class="hover:bg-green-300 border-b border-gray-200 bg-white">
                                            ...
                                            <td class="px-5 py-5 text-sm">
                                                <span class="relative inline-flex px-3 py-1 my-1 font-semibold text-purple-900 leading-tight">
                                                    <span aria-hidden class="absolute inset-0 bg-purple-200 rounded-full"></span>
                                                    <inertia-link class="relative" :href='`/plant/${item.id}/edit`'>Edit</inertia-link>
                                                </span>
                                                <span class="relative inline-flex px-3 py-1 my-1 font-semibold text-red-900 leading-tight">
                                                    <span aria-hidden class="absolute inset-0 bg-red-200 rounded-full"></span>
                                                    <inertia-link method="Delete" preserve-scroll class="relative" as="button" :href='`/plant/${item.id}`'>Delete</inertia-link>
                                                </span>
                                            </td>
                                        </tr>
                                    </tbody>
